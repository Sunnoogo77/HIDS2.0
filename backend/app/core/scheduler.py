...
#     """
#     Programme (ou remplace) un job d'intervalle.
#     - kind: "file" | "folder" | "ip"
#     - entity_id: identifiant DB de l'entité
#     - seconds: intervalle d'exécution
#     - func: fonction cible (ex: scan_file)
#     - **job_kwargs: kwargs passés à func (ex: item_id=..., path=...)
#     """
#     sch = get_scheduler()
